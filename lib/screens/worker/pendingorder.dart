...
class BookingPage extends StatefulWidget {
  var phonenumber0;
  BookingPage(this.phonenumber0);
  @override
  _BookingPageState createState() => _BookingPageState(phonenumber0);
}

class _BookingPageState extends State<BookingPage> {
  var phonenumber0, selectedRoom;
  var _id;
  _BookingPageState(this.phonenumber0);
