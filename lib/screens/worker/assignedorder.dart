...
class assignedorderPage extends StatefulWidget {
  var phonenumber;
  assignedorderPage(this.phonenumber);
  @override
  _assignedorderPageState createState() => _assignedorderPageState(phonenumber);
}

class _assignedorderPageState extends State<assignedorderPage> {
  var phonenumber, selectedRoom;
  var _id;
  _assignedorderPageState(this.phonenumber);
